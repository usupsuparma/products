...
(function ($) {
    ...
    function initLeftMenuCollapse() {
        ...
        $(window).on('load', function () {
            ...
            for (let name of isAttributes.getAttributeNames()) {
                let value = isAttributes.getAttribute(name);
    ...
    function layoutSetting() {
        ...
        (document.documentElement.hasAttribute("data-theme-mode") && document.documentElement.getAttribute("data-theme-mode") == "purple") ? updateRadio('theme-purple') : (document.documentElement.hasAttribute("data-theme-mode") && document.documentElement.getAttribute("data-theme-mode") == "red") ? updateRadio('theme-red') : updateRadio('theme-default');

        (html.hasAttribute("data-bs-theme") && html.getAttribute("data-bs-theme") == "dark") ? updateRadio('layout-mode-dark') : updateRadio('layout-mode-light');
