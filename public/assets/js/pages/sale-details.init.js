...
/*!*************************************************!*\
  !*** ./resources/js/pages/sale-details.init.js ***!
  \*************************************************/
...
option = {
  ...
  //['#1c84ee', '#ffbf53', '#fd625e', '#4ba6ef', '#1c84ee'],
  series: [{
    name: 'Total sales',
    type: 'pie',
    radius: ['30%', '50%'],
...
var options = {
  ...
  //     align: 'center'
  //   },
  colors: ['#A2D2FF', '#9dc9f2', '#9dc9f2', '#9dc9f2', '#9dc9f2', '#9dc9f2', '#7ab1d6', '#7ab1d6', '#7ab1d6', '#7ab1d6', '#9dc9f2', '#9dc9f2'],
  plotOptions: {
    treemap: {
      distributed: true,
      enableShades: false
