                            ...
                            <div class="blog-post">
                                <div class="d-flex align-items-center">
                                    <div class="avatar-lg me-3">
                                        <img src="{{ URL::asset('assets/images/users/avatar-6.jpg') }}" alt="" class="img-fluid rounded-circle d-block">
                                    </div>
                                    <div class="flex-1">
                                ...
                                <div class="position-relative mt-3">
                                    <img src="{{ URL::asset('assets/images/profile-bg.jpg') }}" alt="" class="img-thumbnail">
                                </div>
                                <div class="pt-3">
                                    ...
                                    <div class="mt-4 pt-2">
                                        ...
                                        <div class="mt-4 pt-2">
                                            <div class="comment-section border-bottom pb-4">
                                                <div class="d-flex">
                                                    <img src="{{ URL::asset('assets/images/users/avatar-2.jpg') }}" class="rounded-circle avatar-md" alt="img-missing">
                                            ...
                                            <div class="comment-section pt-4">
                                                <div class="d-flex">
                                                    <img src="{{ URL::asset('assets/images/users/avatar-4.jpg') }}" class="rounded-circle avatar-md" alt="img-missing">
                                                    <div class="flex-1 ms-4">
                                                        <div class="post-meta float-end">
                                                            <span><i class="mdi mdi-calendar me-2"></i>Feb 13, 2021</span>
                                                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                            <div class="blog-post">
                                <div class="d-flex align-items-center">
                                    <div class="avatar-lg me-3">
                                        <img src="{{ URL::asset('assets/images/users/avatar-9.jpg') }}" alt="" class="img-fluid rounded-circle d-block">
                                    </div>
                                    <div class="flex-1">
                                ...
                                <div class="position-relative mt-3">
                                    <img src="{{ URL::asset('assets/images/profile-bg-2.jpg') }}" alt="" class="img-thumbnail">
                                </div>
                                <div class="pt-3">
                                    <div class="d-flex align-items-center justify-content-between border-bottom pb-3">
                                        <div >
