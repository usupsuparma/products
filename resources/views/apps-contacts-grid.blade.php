            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                        <div>
                            <img src="{{ URL::asset('assets/images/users/avatar-2.jpg') }}" alt="" class="avatar-lg rounded-circle img-thumbnail">
                        </div>
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                        <div>
                            <img src="{{ URL::asset('assets/images/users/avatar-3.jpg') }}" alt="" class="avatar-lg rounded-circle img-thumbnail">
                        </div>
                        <div class="flex-1 ms-3">
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                        <div>
                            <img src="{{ URL::asset('assets/images/users/avatar-6.jpg') }}" alt="" class="avatar-lg rounded-circle img-thumbnail">
                        </div>
                        <div class="flex-1 ms-3">
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                        <div>
                            <img src="{{ URL::asset('assets/images/users/avatar-8.jpg') }}" alt="" class="avatar-lg rounded-circle img-thumbnail">
                        </div>
                        <div class="flex-1 ms-3">
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                        <div>
                            <img src="{{ URL::asset('assets/images/users/avatar-9.jpg') }}" alt="" class="avatar-lg rounded-circle img-thumbnail">
                        </div>
                        <div class="flex-1 ms-3">
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                        <div>
                            <img src="{{ URL::asset('assets/images/users/avatar-5.jpg') }}" alt="" class="avatar-lg rounded-circle img-thumbnail">
                        </div>
                        <div class="flex-1 ms-3">
                            <h5 class="font-size-15 mb-1"><a href="#" class="text-dark">Paul Sanchez</a></h5>
                    <p class="text-muted mb-0">Full Stack Developer</p>
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                        <div>
                            <img src="{{ URL::asset('assets/images/users/avatar-7.jpg') }}" alt="" class="avatar-lg rounded-circle img-thumbnail">
                        </div>
                        <div class="flex-1 ms-3">
                            <h5 class="font-size-15 mb-1"><a href="#" class="text-dark">Paul Sanchez</a></h5>
                    <p class="text-muted mb-0">Full Stack Developer</p>
