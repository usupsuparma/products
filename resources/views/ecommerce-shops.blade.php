                ...
                <div class="table-responsive">
                    <table class="table table-centered align-middle table-nowrap table-hover mb-0">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <img src="{{ URL::asset('assets/images/companies/img-1.png') }}" alt="" class="avatar-md p-1">
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <img src="{{ URL::asset('assets/images/companies/img-2.png') }}" alt="" class="avatar-md p-1">
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <img src="{{ URL::asset('assets/images/companies/img-3.png') }}" alt="" class="avatar-md p-1">
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <img src="{{ URL::asset('assets/images/companies/img-5.png') }}" alt="" class="avatar-md p-1">
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <img src="{{ URL::asset('assets/images/companies/img-4.png') }}" alt="" class="avatar-md p-1">
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <img src="{{ URL::asset('assets/images/companies/img-8.png') }}" alt="" class="avatar-md p-1">
                                </td>
                                <td>
                                    <h5 class="font-size-15"> Tech Hifi</h5>
                                    <p class="text-muted mb-0">
    ...
    <div class="col-xl-4">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div id="sales-by-locations" data-colors='["--bs-success"]' style="height: 284px"></div>
...
<script src="{{ URL::asset('assets/js/pages/ecommerce-shop.init.js') }}"></script>
