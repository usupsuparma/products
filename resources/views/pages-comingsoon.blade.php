...
<div class="preview-img overflow-hidden">
    ...
    <div class="swiper-container preview-thumbsnav">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div>
                    <img src="{{ URL::asset('assets/images/bg-1.jpg') }}" alt=""
                        class="avatar-sm nav-img rounded-circle">
                </div>
            </div>
            <div class="swiper-slide">
                <div>
                    <img src="{{ URL::asset('assets/images/bg-2.jpg') }}" alt=""
                        class="avatar-sm nav-img rounded-circle">
                </div>
            </div>
            <div class="swiper-slide">
                    <img src="{{ URL::asset('assets/images/bg-3.jpg') }}" alt=""
                        class="avatar-sm nav-img rounded-circle">
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="text-center py-4 py-sm-5">
                    ...
                    <div data-countdown="2025/12/31" class="counter-number mt-5"></div>
