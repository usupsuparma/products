...
<div class="checkout-tabs">
        <div class="row">
            <div class="col-xl-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    <label for="billing-name" class="col-form-label">Name</label>
                                                    <input type="text" class="form-control" id="billing-name" placeholder="Enter your name">
                                                </div>

                                                <div class="form-group mb-3">
                                                    <label for="billing-phone" class="col-form-label">Phone</label>
                                                ...
                                                <div class="form-group mb-0">
                                                    <label for="example-textarea" class="col-form-label">Order Notes:</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    <label for="billing-email-address" class="col-form-label">Email Address</label>
                                                ...
                                                <div class="form-group mb-3">
                                                    <label for="billing-address" class="col-form-label">Address</label>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table align-middle mb-0 table-nowrap">
                                                ...
                                                <tbody>
                                                <tr>
                                                    <th scope="row"><img src="<?php echo e(URL::asset('assets/images/product/img-1.png')); ?>" alt="product-img" title="product-img" class="avatar-md"></th>
                                                    <td>
                                                        <h5 class="font-size-14 text-truncate"><a href="<?php echo e(url('ecommerce-product-detail')); ?> " class="text-dark">Half sleeve T-shirt  (64GB) </a></h5>
                                                        <p class="text-muted mb-0">$ 450 x 1</p>
                                                    </td>
                                                    <td>$ 450</td>
                                                </tr>
                                                <tr>
                                                    <th scope="row"><img src="<?php echo e(URL::asset('assets/images/product/img-7.png')); ?>" alt="product-img" title="product-img" class="avatar-md"></th>
                                                    <td>
                                                        <h5 class="font-size-14 text-truncate"><a href="<?php echo e(url('ecommerce-product-detail')); ?>" class="text-dark">Wireless Headphone </a></h5>
                ...
                <div class="row my-4">
                    <div class="col-sm-6">
                        <a href="<?php echo e(url('ecommerce-cart')); ?>" class="btn text-muted d-none d-sm-inline-block btn-link">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\template\Dason_Laravel_v1.1.0\Admin\resources\views/ecommerce-checkout.blade.php ENDPATH**/ ?>