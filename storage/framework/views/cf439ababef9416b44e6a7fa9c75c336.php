        ...
        <div class="email-leftbar card">
            ...
            <div class="mt-2">
                <a href="javascript: void(0);" class="d-flex align-items-start">
                    <img class="flex-shrink-0 me-3 rounded-circle" src="<?php echo e(URL::asset('assets/images/users/avatar-2.jpg')); ?>" alt="Generic placeholder image" height="36">
                ...
                <a href="javascript: void(0);" class="d-flex align-items-start">
                    <img class="flex-shrink-0 me-3 rounded-circle" src="<?php echo e(URL::asset('assets/images/users/avatar-3.jpg')); ?>" alt="Generic placeholder image" height="36">
                    <div class="flex-grow-1 chat-user-box">
                ...
                <a href="javascript: void(0);" class="d-flex align-items-start">
                    <img class="flex-shrink-0 me-3 rounded-circle" src="<?php echo e(URL::asset('assets/images/users/avatar-4.jpg')); ?>" alt="Generic placeholder image" height="36">
                    <div class="flex-grow-1 chat-user-box">
                ...
                <a href="javascript: void(0);" class="d-flex align-items-start">
                    <img class="flex-shrink-0 me-3 rounded-circle" src="<?php echo e(URL::asset('assets/images/users/avatar-6.jpg')); ?>" alt="Generic placeholder image" height="36">
                    <div class="flex-grow-1 chat-user-box">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-4">
                        <div class="flex-shrink-0 me-3">
                            <img class="rounded-circle avatar-sm" src="<?php echo e(URL::asset('assets/images/users/avatar-2.jpg')); ?>" alt="Generic placeholder image">
                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\template\Dason_Laravel_v1.1.0\Admin\resources\views/apps-email-read.blade.php ENDPATH**/ ?>