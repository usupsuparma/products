                                ...
                                <div class="col-md-2 col-sm-3 col-4">
                                    <div class="nav flex-column nav-pills " id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                        <a class="nav-link active" id="product-1-tab" data-bs-toggle="pill" href="#product-1" role="tab" aria-controls="product-1" aria-selected="true">
                                            <img src="<?php echo e(URL::asset('assets/images/product/img-7.png')); ?>" alt="" class="img-fluid mx-auto d-block rounded">
                                        </a>
                                        <a class="nav-link" id="product-2-tab" data-bs-toggle="pill" href="#product-2" role="tab" aria-controls="product-2" aria-selected="false">
                                            <img src="<?php echo e(URL::asset('assets/images/product/img-8.png')); ?>" alt="" class="img-fluid mx-auto d-block rounded">
                                        </a>
                                ...
                                <div class="col-md-7 offset-md-1 col-sm-9 col-8">
                                    <div class="tab-content" id="v-pills-tabContent">
                                        <div class="tab-pane fade show active" id="product-1" role="tabpanel" aria-labelledby="product-1-tab">
                                            <div>
                                                <img src="<?php echo e(URL::asset('assets/images/product/img-7.png')); ?>" alt="" class="img-fluid mx-auto d-block">
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="product-2" role="tabpanel" aria-labelledby="product-2-tab">
                                            <div>
                                                <img src="<?php echo e(URL::asset('assets/images/product/img-8.png')); ?>" alt="" class="img-fluid mx-auto d-block">
                                            </div>
                                        </div>
                            ...
                            <div class="product-color">
                                ...
                                <a href="javascript: void(0);" class="active">
                                    <div class="product-color-item border rounded">
                                        <img src="<?php echo e(URL::asset('assets/images/product/img-7.png')); ?>" alt="" class="avatar-lg">
                                    </div>
                                    <p>Black</p>
                                </a>
                    ...
                    <div class="mt-4 border p-4">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-5">
                                <div>
                                    <div class="d-flex">
                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-2.jpg')); ?>" class="avatar-sm rounded-circle" alt="img" />
                    ...
                    <div class="mt-4 border p-4">
                        <div class="row">
                            <div class="col-xl-3 col-md-5">
                                <div>
                                    <div class="d-flex">
                                        <img src="<?php echo e(URL::asset('assets/images/users/avatar-4.jpg')); ?>" class="avatar-sm rounded-circle" alt="img" />
                                        <div class="flex-1 ms-4">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-5">
                                <div>
                                    <div class="d-flex">
                                        <div class="avatar-sm">
                                            <span class="avatar-title bg-primary-subtle text-primary rounded-circle font-size-16">
                                                N
                                            </span>
                                        </div>
                                        <div class="flex-1 ms-4">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\template\Dason_Laravel_v1.1.0\Admin\resources\views/ecommerce-product-detail.blade.php ENDPATH**/ ?>