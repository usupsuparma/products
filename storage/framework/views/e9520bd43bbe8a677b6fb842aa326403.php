...
<?php $__env->slot('title'); ?> Basic Elements <?php $__env->endSlot(); ?>
                    ...
                    <div class="col-lg-6">
                        <div class="mt-3 mt-lg-0">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="color" class="form-control form-control-color mw-100" id="example-color-input" value="#1c84ee" title="Choose your color">
                            </div>
                            <div class="mb-3">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\template\Dason_Laravel_v1.1.0\Admin\resources\views/form-elements.blade.php ENDPATH**/ ?>