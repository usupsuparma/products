        ...
        <div class="p-3 px-4 border-bottom">
            <div class="d-flex align-items-start ">
                ...
                <div class="flex-grow-1">
                    <h5 class="font-size-16 mb-1"><a href="#" class="text-dark">Paul <i class="mdi mdi-circle text-success align-middle font-size-10 ms-1"></i></a></h5>
                                    ...
                                    <a href="#">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-shrink-0 user-img online align-self-center me-3">
                                                <img src="<?php echo e(URL::asset('assets/images/users/avatar-2.jpg')); ?>" class="rounded-circle avatar-sm" alt="">
                                    ...
                                    <a href="#">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-shrink-0 user-img align-self-center me-3">
                                                <img src="<?php echo e(URL::asset('assets/images/users/avatar-4.jpg')); ?>" class="rounded-circle avatar-sm" alt="">
                                                <span class="user-status"></span>
                                            </div>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="flex-shrink-0 user-img align-self-center me-3">
                                                <img src="<?php echo e(URL::asset('assets/images/users/avatar-5.jpg')); ?>" class="rounded-circle avatar-sm" alt="">
                                                <span class="user-status"></span>
                                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\template\Dason_Laravel_v1.1.0\Admin\resources\views/apps-chat.blade.php ENDPATH**/ ?>