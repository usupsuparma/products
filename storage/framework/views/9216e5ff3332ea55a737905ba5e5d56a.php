                        ...
                        <div class="row">
                            <div class="col-xl-4 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" required class="form-control" placeholder="Type something"/>
                                </div>
                            </div>
                            <div class="col-xl-4 col-md-6">
                                <div class="form-group mb-3">
                                    <label class="form-label">minlength=5, but not required</label>
                                    <input type="text" minlength="5" class="form-control" placeholder="Min length is 6"/>
                                </div>
                            </div>
                            <div class="col-xl-4 col-md-6">
                                <div class="form-group mb-3">
                            ...
                            <div class="col-xl-4 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control" placeholder="Enter only digits" />
                                </div>
                            </div>
                            <div class="col-xl-4 col-md-6">
                                <div class="form-group mb-3">
                                    <label class="form-label">number, min=100, not required</label>
                                    <input type="number" min="100" class="form-control" placeholder="Min value is 100" />
                                </div>
                            </div>
                            <div class="col-xl-4 col-md-6">
                                <div class="form-group mb-3">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\template\Dason_Laravel_v1.1.0\Admin\resources\views/form-validation.blade.php ENDPATH**/ ?>