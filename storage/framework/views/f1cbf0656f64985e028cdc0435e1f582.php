...
<link href="<?php echo e(URL::asset('assets/libs/twitter-bootstrap-wizard/twitter-bootstrap-wizard.min.css')); ?>" rel="stylesheet">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="email" class="form-control" id="progresspill-email-input" placeholder="Enter Your Email ID">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="progresspill-companyuin-input" placeholder="Company UIN No.">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="progresspill-declaration-input" placeholder="Declaration Details">
                                        </div>
                                    </div>
                                </div>
                            </form>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="progresspill-cardno-input" placeholder="Enter Your Card Number">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="progresspill-card-verification-input" placeholder="Card Verification Number">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="progresspill-expiration-input" placeholder="Card Expiration Date">
                                            </div>
                                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\template\Dason_Laravel_v1.1.0\Admin\resources\views/form-wizard.blade.php ENDPATH**/ ?>