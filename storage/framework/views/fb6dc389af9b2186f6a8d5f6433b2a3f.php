            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="ecommerce-seller" data-key="t-seller"><?php echo app('translator')->get('translation.Seller'); ?>
                            <span class="badge rounded-pill bg-danger-subtle text-danger float-end">New</span>
                        </a></li>
                        <li><a href="ecommerce-sale-details" data-key="t-sale-details"><?php echo app('translator')->get('translation.Sale_details'); ?>
                            <span class="badge rounded-pill bg-danger-subtle text-danger float-end">New</span>
                        </a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="ui-utilities" data-key="t-utility"><?php echo app('translator')->get('translation.Utilities'); ?>
                            <span class="badge rounded-pill bg-danger-subtle text-danger float-end">New</span>
                        </a></li>
                    </ul>
                </li>
...
<!-- Left Sidebar End -->
<?php /**PATH D:\template\Dason_Laravel_v1.1.0\Admin\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>